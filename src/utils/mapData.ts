 ...
 * The ultimate endgame realm: Massive gothic central castle, floating sky islands,
 * grand celestial viaduct bridges, roaring cosmic waterfalls, and the Mythical Sky Throne.
 */
export const MYTHICAL_CASTLE_LEVELS: MapLevelDef[] = [
  {
    id: 41,
    levelNumber: 41,
    name: 'Southwest Dragon Altar Island',
    worldId: 'mythical-castle',
    description: 'A floating obsidian altar encircled by ancient carved runes and magenta stardust crystals suspended over the cosmic clouds.',
    icon: '🌌',
    position: { x: 145, y: 860 },
    pathPointsToNext: [
      { x: 150, y: 770 },
      { x: 155, y: 680 },
      { x: 160, y: 600 },
  ...
  },
  {
    id: 42,
    levelNumber: 42,
    name: 'West Obsidian Bastion Spire',
    worldId: 'mythical-castle',
    description: 'A grand watchtower bastion overlooking cosmic nebulae and the flying dragon soaring across the starry void.',
    icon: '🐉',
  ...
  },
  {
    id: 43,
    levelNumber: 43,
    name: 'West Celestial Viaduct Bridge',
    worldId: 'mythical-castle',
    description: 'A monumental stone-arch viaduct bridge spanning across cosmic chasms with waterfalls plunging into the infinite abyss.',
    icon: '🌉',
  ...
  },
  {
    id: 44,
    levelNumber: 44,
    name: 'Grand Dragon Circle Plaza',
    worldId: 'mythical-castle',
    description: 'The monumental central citadel courtyard centered around a carved dragon rune circle and flaming golden braziers.',
    icon: '🏛️',
  ...
  },
  {
    id: 45,
    levelNumber: 45,
    name: 'Grand Mythic Castle Portal Gate',
    worldId: 'mythical-castle',
    description: 'The imposing gold-adamantine portcullis entrance to the Supreme Citadel, crowned with crenellated fortress battlements.',
    icon: '🏰',
  ...
  },
  {
    id: 46,
    levelNumber: 46,
    name: 'East Celestial Causeway Bridge',
    worldId: 'mythical-castle',
    description: 'A sweeping arched stone causeway linking the central citadel to the floating eastern mountain ridges.',
    icon: '🌉',
  ...
  },
  {
    id: 47,
    levelNumber: 47,
    name: 'East Mountain Waterfall Ridge',
    worldId: 'mythical-castle',
    description: 'A high alpine floating ridge with ancient hero monoliths and thundering waterfalls cascading into purple nebulae.',
    icon: '🏔️',
  ...
  },
  {
    id: 48,
    levelNumber: 48,
    name: 'Northeast Floating Star Sanctum',
    worldId: 'mythical-castle',
    description: 'An elevated sanctuary altar bathed in golden moonlight and crowned by glowing celestial cyan crystal spires.',
    icon: '🔮',
  ...
  },
  {
    id: 49,
    levelNumber: 49,
    name: 'High Celestial Spire Ascent',
    worldId: 'mythical-castle',
    description: 'A vaulted cathedral staircase ascending the supreme gothic spire past stained-glass rose windows.',
    icon: '✨',
  ...
  },
  {
    id: 50,
    levelNumber: 50,
    name: 'Mythical Crown Pinnacle & Sky Throne',
    worldId: 'mythical-castle',
    description: 'The ultimate final pinnacle of the entire RPG journey: the floating golden Mythical Crown radiating infinite celestial glory.',
    icon: '👑',
