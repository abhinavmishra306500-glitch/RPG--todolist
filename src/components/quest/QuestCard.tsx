  ...
  return (
    <div
      className={`relative p-3.5 border-2 transition-all duration-300 ${
        quest.completed
          ? 'bg-[#12101e]/80 border-[#26203c] opacity-80 shadow-none'
    ...
    >
      {/* Completion Celebration Overlay Animation */}
      {justCompleted && (
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        {/* Left: Category Icon, Quest Title, Badges */}
        <div className="flex items-start gap-3 flex-1 min-w-0">
          ...
          <div className="space-y-1.5 flex-1 min-w-0">
            ...
            {/* Badges: Category, Difficulty, Deadline */}
            <div className="flex items-center gap-2 flex-wrap text-[10px]">
              ...
              {/* Deadline */}
              <span className="inline-flex items-center gap-1 text-slate-400 font-mono text-[10px] bg-black/40 px-2 py-0.5 border border-[#2d264a]">
