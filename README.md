...
### ✅ Step 7: 🐾 Pet System & CreatureDex
- **10 Original Creatures**:
  - 🐰 **Bunbun** (Starter)
  - 🐱 **Mewmi** (Common)
  - 🐶 **Fluffo** (Common)
  - 🦊 **Foxlet** (Uncommon)
  ...
  - 🌙 **Moonpaw** (Epic)
  - 🐉 **Drakori** (Legendary)
- **Unique Audio Synthesizers**:
  - Every pet features an original procedural Web Audio synthesizer chime for **equipping** and **ambient movement vocalizations** while walking the map.
- **CreatureDex (`CreatureDexModal.tsx`)**:
  - Interactive lore catalog showing stats, rarity badges, descriptions, lore entries, and animated sprites.

### ✅ Step 8: 🏠 Personal Home Environment
- **Personal Living Space (`HomeView.tsx`)**:
  - Displays the player's character and equipped companion pet in their home environment.
  - Includes classic RPG starter furniture: 🛏️ Cozy Bed, 📚 Bookshelf, 🪴 Houseplant Fern, and 🪑 Crafted Chair & Table.
  - Live Gold balance display and direct navigation to the Shops.

### ✅ Step 9: 🛍️ Shops & Kingdom Bazaar
- **🐾 Pet Shop**: All 10 companions adoptable with Gold or unlocked via quest/streak milestones.
- **👕 Character Shop**: 14 original cosmetic items across 3 categories (`👑 Headwear`, `👕 Outfits`, `🧣 Accessories`) with live character wardrobe stage.
- **🏠 Home Shop**: Furniture catalog preview for future home customization.

### ✅ Step 10: 🔒 Developer Shortcut Keys
- **Global / Shop Shortcuts**:
  - <kbd>Shift</kbd> + <kbd>L</kbd> / <kbd>L</kbd>: **Lock ALL items** in Pet & Character Shops.
  - <kbd>Shift</kbd> + <kbd>U</kbd> / <kbd>U</kbd>: **Unlock ALL items** (+ 50,000 Gold for testing).
- **Hover & Card Shortcuts**:
  - Hover over any Pet or Cosmetic + <kbd>L</kbd>: **Locks** that specific item.
  - Hover over any Pet or Cosmetic + <kbd>U</kbd>: **Unlocks** that specific item.
  - Hover + <kbd>T</kbd> / <kbd>X</kbd> or <kbd>Alt</kbd>+Click: **Toggles** lock/unlock.
  - Direct 1-click **`[ 🔒 Lock [L] ]`** / **`[ 🔓 Unlock [U] ]`** buttons on every card.
