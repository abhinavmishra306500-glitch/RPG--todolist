...
## Features (Step 1: Project Foundation)

- **2D Pixel-Art RPG Visual Aesthetic**:
  - Original top-down retro overworld environment with meadow grass, cozy cottage, animated chimney smoke, trees, and river.
...
- **Dual Access Portal**:
  ...
  - **🛠️ Developer / Admin Login**: Sandbox testing access for maps, levels, pets, magic, and debug controls (no signup).
- **Tech Stack**:
  - React 19
  - TypeScript
  - Vite
